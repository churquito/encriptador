...
var contenedor1 = document.querySelector(".contenedor-parrafo1");
var contenedor2 = document.querySelector(".contenedor-parrafo2");
...
const btnCopiar = document.querySelector(".btn-copiar")
    ...
    navigator.clipboard.writeText(document.querySelector(".texto-resultado").textContent);
